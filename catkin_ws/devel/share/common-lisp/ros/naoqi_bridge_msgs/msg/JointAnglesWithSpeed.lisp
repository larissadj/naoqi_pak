...
(cl:defmethod cl:initialize-instance :after ((m <JointAnglesWithSpeed>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointAnglesWithSpeed)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name naoqi_bridge_msgs-msg:<JointAnglesWithSpeed> is deprecated: use naoqi_bridge_msgs-msg:JointAnglesWithSpeed instead.")))
