...
(cl:in-package my_package_1-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_package_1-msg:<Num> is deprecated: use my_package_1-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_package_1-msg:num-val is deprecated.  Use my_package_1-msg:num instead.")
  (num m))
