...
if("TRUE" STREQUAL "TRUE")
  set(footstep_planner_SOURCE_PREFIX /home/faps/catkin_ws/src/humanoid_navigation/footstep_planner)
  set(footstep_planner_DEVEL_PREFIX /home/faps/catkin_ws/devel)
  ...
  set(footstep_planner_INSTALL_PREFIX /home/faps/catkin_ws/install)
...
if(NOT "/home/faps/catkin_ws/src/humanoid_navigation/footstep_planner/include " STREQUAL " ")
  set(footstep_planner_INCLUDE_DIRS "")
  set(_include_dirs "/home/faps/catkin_ws/src/humanoid_navigation/footstep_planner/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://ros.org/wiki/footstep_planner " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/footstep_planner' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'footstep_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/faps/catkin_ws/src/humanoid_navigation/footstep_planner/${idir}'.  ${_report}")
    endif()
    _list_append_unique(footstep_planner_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "footstep_planner")
