...
class BodyPoseWithSpeedActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type BodyPoseWithSpeedActionFeedback
    ...
    bufferOffset = BodyPoseWithSpeedFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type BodyPoseWithSpeedActionFeedback
    let len;
    let data = new BodyPoseWithSpeedActionFeedback(null);
    ...
    data.feedback = BodyPoseWithSpeedFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new BodyPoseWithSpeedActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = BodyPoseWithSpeedFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new BodyPoseWithSpeedFeedback()
    }
...
module.exports = BodyPoseWithSpeedActionFeedback;
