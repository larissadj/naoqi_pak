...
class BodyPoseWithSpeedActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type BodyPoseWithSpeedActionGoal
    // Serialize message field [header]
    bufferOffset = std_msgs.msg.Header.serialize(obj.header, buffer, bufferOffset);
    // Serialize message field [goal_id]
    bufferOffset = actionlib_msgs.msg.GoalID.serialize(obj.goal_id, buffer, bufferOffset);
    // Serialize message field [goal]
    bufferOffset = BodyPoseWithSpeedGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type BodyPoseWithSpeedActionGoal
    let len;
    let data = new BodyPoseWithSpeedActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = BodyPoseWithSpeedGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += BodyPoseWithSpeedGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new BodyPoseWithSpeedActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = BodyPoseWithSpeedGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new BodyPoseWithSpeedGoal()
    }
...
module.exports = BodyPoseWithSpeedActionGoal;
