...
"""autogenerated by genpy from naoqi_bridge_msgs/BodyPoseWithSpeedActionResult.msg. Do not edit."""
import sys
...
class BodyPoseWithSpeedActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "naoqi_bridge_msgs/BodyPoseWithSpeedActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','naoqi_bridge_msgs/BodyPoseWithSpeedResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BodyPoseWithSpeedActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = naoqi_bridge_msgs.msg.BodyPoseWithSpeedResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = naoqi_bridge_msgs.msg.BodyPoseWithSpeedResult()
