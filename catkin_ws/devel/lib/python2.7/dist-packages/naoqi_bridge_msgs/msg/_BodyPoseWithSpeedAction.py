...
"""autogenerated by genpy from naoqi_bridge_msgs/BodyPoseWithSpeedAction.msg. Do not edit."""
import sys
...
class BodyPoseWithSpeedAction(genpy.Message):
  _md5sum = "8843d4cb535c2767e978466b886561fb"
  _type = "naoqi_bridge_msgs/BodyPoseWithSpeedAction"
...
"""
  ...
  _slot_types = ['naoqi_bridge_msgs/BodyPoseWithSpeedActionGoal','naoqi_bridge_msgs/BodyPoseWithSpeedActionResult','naoqi_bridge_msgs/BodyPoseWithSpeedActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BodyPoseWithSpeedAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = naoqi_bridge_msgs.msg.BodyPoseWithSpeedActionGoal()
      if self.action_result is None:
        self.action_result = naoqi_bridge_msgs.msg.BodyPoseWithSpeedActionResult()
      if self.action_feedback is None:
        self.action_feedback = naoqi_bridge_msgs.msg.BodyPoseWithSpeedActionFeedback()
    else:
      self.action_goal = naoqi_bridge_msgs.msg.BodyPoseWithSpeedActionGoal()
      self.action_result = naoqi_bridge_msgs.msg.BodyPoseWithSpeedActionResult()
      self.action_feedback = naoqi_bridge_msgs.msg.BodyPoseWithSpeedActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.posture_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_f3I().pack(_x.action_goal.goal.speed, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.posture_name = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.posture_name = str[start:end]
      _x = self
      start = end
      end += 16
      (_x.action_goal.goal.speed, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
