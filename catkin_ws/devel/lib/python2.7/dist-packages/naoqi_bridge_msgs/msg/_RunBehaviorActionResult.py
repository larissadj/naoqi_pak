...
"""autogenerated by genpy from naoqi_bridge_msgs/RunBehaviorActionResult.msg. Do not edit."""
import sys
...
class RunBehaviorActionResult(genpy.Message):
  ...
  _type = "naoqi_bridge_msgs/RunBehaviorActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','naoqi_bridge_msgs/RunBehaviorResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = naoqi_bridge_msgs.msg.RunBehaviorResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = naoqi_bridge_msgs.msg.RunBehaviorResult()
